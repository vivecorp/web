...
<page backcolor="#FEFEFE" backimg="./res/bas_page.png" backimgx="center" backimgy="bottom" backimgw="100%" backtop="0" backbottom="30mm" footer="date;heure;page" style="font-size: 12pt">
    ...
    <--tabla para el logo a la izquierda-->
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 14px">
        <tr>
            <td style="width: 75%;">
            </td>
            <td style="width: 25%; color: #192a88;">
    ...
    <br>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #43b664; text-align: center; font-size: 10pt;">
        <tr>
...
?>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #620808; text-align: center; font-size: 10pt;">
        <tr>
