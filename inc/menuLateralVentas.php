...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li><a class="app-menu__item" href="gestionarVentas.php"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Gestionar Ventas</span></a></li>
    ...
    <li><a class="app-menu__item" href="precioVenta.php"><i class="app-menu__icon fa fa-usd"></i><span class="app-menu__label">Precio de Venta</span></a></li>
